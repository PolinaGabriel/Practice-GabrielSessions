...
public partial class PostgresContext : DbContext
{
    ...
    public virtual DbSet<TimetableStatus> TimetableStatuses { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Timetable>(entity =>
        {
            ...
            entity.Property(e => e.TimetableEnd)
                .HasColumnType("timestamp without time zone")
                .HasColumnName("timetable_end");
            ...
            entity.Property(e => e.TimetableStart)
                .HasColumnType("timestamp without time zone")
                .HasColumnName("timetable_start");
            entity.Property(e => e.TimetableStatus).HasColumnName("timetable_status");
            ...
            entity.HasOne(d => d.TimetableStatusNavigation).WithMany(p => p.Timetables)
                .HasForeignKey(d => d.TimetableStatus)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("timetable_timetable_status_fk");
        });

        modelBuilder.Entity<TimetableStatus>(entity =>
        {
            entity.HasKey(e => e.TimetableStatusId).HasName("event_status_pk");

            entity.ToTable("timetable_status", "calendar");

            entity.Property(e => e.TimetableStatusId)
                .UseIdentityAlwaysColumn()
                .HasColumnName("timetable_status_id");
            entity.Property(e => e.TimetableStatusName)
                .HasColumnType("character varying")
                .HasColumnName("timetable_status_name");
        });
